...
const CustomBeaconComponent = ({ closeTourPermanently, continueTour }) => (
    <div className='tour__beacon'>
        ...
        <div className='tour__checkbox'>
            ...
            <label htmlFor='chkAskAgain'>{translate('Do not ask me again.')}</label>
        </div>
    </div>
);
...
const ForthStep = () => (
    <p>{translate('Login before starting your bot. Always test your strategies with the virtual account.')}</p>
);
